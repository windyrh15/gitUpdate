...
<input type="text" id="client" class="swal2-input form-add" placeholder="Customer">
<div id="suggestionClient" class="suggestions-container"></div>

<ul id="clientList" class="client-list scrollable-card-body" style="list-style-type: none; text-align: left;"></ul>
<!-- <small class="text-danger"><i>Only .pdf extension are allowed</i></small>
